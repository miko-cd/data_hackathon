...
def compile_currency_symbol_regex(sym_to_country: dict[str, str]) -> Optional[re.Pattern]:
...
def expand_currency_symbols_to_country(text: str, sym_to_country: dict[str, str], sym_re: Optional[re.Pattern]) -> str:
...
def clean_text(text: str,
               abbr_map: dict[str, str], abbr_re: Optional[re.Pattern],
               cur_map: dict[str, str], cur_re: Optional[re.Pattern]) -> str:
...
def build_cleaner(
    ...
    def normalize_text(text: str) -> str:
        ...
        return clean_text(text, abbr_map, abbr_re, cur_map, cur_re)
...
def main(
    ...
    # notebook-д ашиглахад
    return build_cleaner(abbr_xlsx_path, currency_xlsx_path)